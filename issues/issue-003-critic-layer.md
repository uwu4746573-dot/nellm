# [Resolved] Issue 3: Implement CriticLayer
...
## Tasks
- [x] Create `CriticLayer` `nn.Module`.
- [x] Implement the MLP architecture (`Linear(D_v, 256) -> Activation -> Linear(256, 1)`).
- [x] Apply Sigmoid activation to produce probability.
- [x] (Optional) Add capability to condition on initial fact `F_1`.
- [x] Add unit tests verifying bounds `[0, 1]` and shapes.
